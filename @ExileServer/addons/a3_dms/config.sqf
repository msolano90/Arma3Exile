...
/* AI Settings */
	...
	DMS_Bandit_Soldier_MoneyGain		= 500;						// The amount of Poptabs gained for killing a bandit soldier
	...
	DMS_Bandit_Static_MoneyGain			= 750;						// The amount of Poptabs gained for killing a bandit static gunner
	...
	DMS_Bandit_Static_SpawnMoney		= 750;						// The amount of Poptabs carried by a bandit static gunner

	DMS_Bandit_Vehicle_MoneyGain		= 1000;						// The amount of Poptabs gained for killing a bandit vehicle crew member
	...
	DMS_Bandit_Vehicle_SpawnMoney		= 1000;						// The amount of Poptabs carried by a bandit vehicle crew member
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_skill_static					= [["aimingAccuracy",0.25],["aimingShake",0.25],["aimingSpeed",0.25],["spotDistance",0.25],["spotTime",0.20],["courage",0.50],["reloadSpeed",0.50],["commanding",0.50],["general",0.50]];	// Static AI Skills
	DMS_ai_skill_easy					= [["aimingAccuracy",0.10],["aimingShake",0.25],["aimingSpeed",0.15],["spotDistance",0.15],["spotTime",0.10],["courage",0.20],["reloadSpeed",0.50],["commanding",0.50],["general",0.15]];	// Easy
	DMS_ai_skill_moderate				= [["aimingAccuracy",0.20],["aimingShake",0.25],["aimingSpeed",0.25],["spotDistance",0.25],["spotTime",0.20],["courage",0.40],["reloadSpeed",0.50],["commanding",0.50],["general",0.25]];	// Moderate
	DMS_ai_skill_difficult				= [["aimingAccuracy",0.30],["aimingShake",0.25],["aimingSpeed",0.35],["spotDistance",0.35],["spotTime",0.30],["courage",0.60],["reloadSpeed",0.40],["commanding",0.50],["general",0.35]]; 	// Difficult
	DMS_ai_skill_hardcore				= [["aimingAccuracy",0.40],["aimingShake",0.25],["aimingSpeed",0.45],["spotDistance",0.40],["spotTime",0.40],["courage",0.80],["reloadSpeed",0.35],["commanding",0.50],["general",0.50]]; 	// Hardcore
	...
	DMS_ai_skill_randomDifficult		= ["hardcore","moderate","moderate","difficult","difficult"];	// 20% chance for "difficult", 40% chance for "hardcore" AI, 40% chance for "moderate' AI.
	DMS_ai_skill_randomEasy				= ["moderate","easy","easy","easy","easy"];					// 80% chance for "easy", 20% chance for "moderate" AI.
	DMS_ai_skill_randomIntermediate		= ["difficult","easy","moderate","easy","moderate"];	// 20% chance for "moderate", 40% chance for "difficult" AI, 40$ chance for "easy" AI.
	...
	DMS_AI_AimCoef_moderate				= 0.9;						// "Custom Aim Coefficient" (weapon sway multiplier) for "moderate" AI
	DMS_AI_AimCoef_difficult			= 0.7;						// "Custom Aim Coefficient" (weapon sway multiplier) for "difficult" AI
	DMS_AI_AimCoef_hardcore				= 0.5;						// "Custom Aim Coefficient" (weapon sway multiplier) for "hardcore" AI
	...
	DMS_AI_destroyStaticWeapon_chance	= 75;						// Percent chance that a static weapon will be destroyed (only applied if "DMS_AI_destroyStaticWeapon" is true)
