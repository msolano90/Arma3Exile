...
ExAd_HALOPARACHUTE_SAFE_MODE = true;	//BOOLEAN - Force pull parachute when player reaches ExAd_ACTION_PARACHUTE_HEIGHT if they ejected from vehicle
...
ExAd_ACTION_PARACHUTE_HEIGHT = 30; 		//SCALAR - What is the minimum altitude a player can pull a parachute. |RECOMMENDED 30 meters when safe_mode activated
